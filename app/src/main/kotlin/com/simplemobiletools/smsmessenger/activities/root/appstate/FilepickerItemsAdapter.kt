...
class FilepickerItemsAdapter(
    activity: BaseRootActivity, val fileDirItems: List<FileDirItem>, recyclerView: MyRecyclerView,
    itemClick: (Any) -> Unit
) : com.simplemobiletools.smsmessenger.adapters.MyRecyclerViewAdapter(activity, recyclerView, itemClick), RecyclerViewFastScroller.OnPopupTextUpdate {
