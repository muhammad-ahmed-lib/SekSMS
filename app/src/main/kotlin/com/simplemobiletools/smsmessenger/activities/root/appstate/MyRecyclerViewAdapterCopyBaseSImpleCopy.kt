...
abstract class MyRecyclerViewAdapterCopyBaseSImpleCopy(val activity: BaseSimpleCopy, val recyclerView: MyRecyclerView, val itemClick: (Any) -> Unit) :
    RecyclerView.Adapter<MyRecyclerViewAdapterCopyBaseSImpleCopy.ViewHolder>() {
