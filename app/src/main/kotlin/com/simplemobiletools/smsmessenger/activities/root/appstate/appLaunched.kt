...
fun BaseRootActivity.isShowingSAFDialog(path: String): Boolean {
...
fun BaseRootActivity.isShowingSAFDialogSdk30(path: String): Boolean {
...
@SuppressLint("InlinedApi")
fun BaseRootActivity.isShowingSAFCreateDocumentDialogSdk30(path: String): Boolean {
...
fun BaseRootActivity.isShowingAndroidSAFDialog(path: String): Boolean {
...
fun BaseRootActivity.isShowingOTGDialog(path: String): Boolean {
...
fun BaseRootActivity.showOTGPermissionDialog(path: String) {
    runOnUiThread {
        if (!isDestroyed && !isFinishing) {
...
fun BaseRootActivity.checkWhatsNew(releases: List<Release>, currVersion: Int) {
...
fun BaseRootActivity.deleteFolders(folders: List<FileDirItem>, deleteMediaOnly: Boolean = true, callback: ((wasSuccess: Boolean) -> Unit)? = null) {
    ensureBackgroundThread {
        deleteFoldersBg(folders, deleteMediaOnly, callback)
    }
}

fun BaseRootActivity.deleteFoldersBg(folders: List<FileDirItem>, deleteMediaOnly: Boolean = true, callback: ((wasSuccess: Boolean) -> Unit)? = null) {
...
fun BaseRootActivity.deleteFolder(folder: FileDirItem, deleteMediaOnly: Boolean = true, callback: ((wasSuccess: Boolean) -> Unit)? = null) {
    ensureBackgroundThread {
        deleteFolderBg(folder, deleteMediaOnly, callback)
    }
}

fun BaseRootActivity.deleteFolderBg(fileDirItem: FileDirItem, deleteMediaOnly: Boolean = true, callback: ((wasSuccess: Boolean) -> Unit)? = null) {
...
fun BaseRootActivity.deleteFile(file: FileDirItem, allowDeleteFolder: Boolean = false, callback: ((wasSuccess: Boolean) -> Unit)? = null) {
    deleteFiles(arrayListOf(file), allowDeleteFolder, callback)
}

fun BaseRootActivity.deleteFiles(files: List<FileDirItem>, allowDeleteFolder: Boolean = false, callback: ((wasSuccess: Boolean) -> Unit)? = null) {
    ensureBackgroundThread {
        deleteFilesBg(files, allowDeleteFolder, callback)
    }
}

fun BaseRootActivity.deleteFilesBg(files: List<FileDirItem>, allowDeleteFolder: Boolean = false, callback: ((wasSuccess: Boolean) -> Unit)? = null) {
    if (files.isEmpty()) {
        runOnUiThread {
            callback?.invoke(true)
        }
...
private fun BaseRootActivity.deleteFilesCasual(
...
fun BaseRootActivity.deleteFile(
...
fun BaseRootActivity.deleteFileBg(
    fileDirItem: FileDirItem,
    allowDeleteFolder: Boolean = false,
    isDeletingMultipleFiles: Boolean,
    callback: ((wasSuccess: Boolean) -> Unit)? = null,
...
private fun BaseRootActivity.deleteSdk30(fileDirItem: FileDirItem, callback: ((wasSuccess: Boolean) -> Unit)?) {
...
fun BaseRootActivity.renameFile(
    oldPath: String,
    newPath: String,
...
private fun BaseRootActivity.renameCasually(
    oldPath: String,
    newPath: String,
    isRenamingMultipleFiles: Boolean,
...
fun BaseRootActivity.getFileOutputStream(fileDirItem: FileDirItem, allowCreatingNewFile: Boolean = false, callback: (outputStream: OutputStream?) -> Unit) {
...
private fun createCasualFileOutputStream(activity: BaseRootActivity, targetFile: File): OutputStream? {
...
fun BaseRootActivity.getAlarmSounds(type: Int, callback: (ArrayList<AlarmSound>) -> Unit) {
