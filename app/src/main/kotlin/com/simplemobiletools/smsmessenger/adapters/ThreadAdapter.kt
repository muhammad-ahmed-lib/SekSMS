...
) : com.simplemobiletools.smsmessenger.adapters.MyRecyclerViewListAdapter<ThreadItem>(activity, recyclerView, ThreadItemDiffCallback(), itemClick) {
...
/*
    ...
    private fun setupSentMessageView(messageBinding: ItemMessageBinding, message: Message) {
        messageBinding.apply {
            ...
            val primaryColor  ="#D9EBFF".toColorInt()
