...
abstract class BaseConversationsAdapter(
    activity: BaseRootActivity, recyclerView: MyRecyclerView, onRefresh: () -> Unit, itemClick: (Any) -> Unit
) : com.simplemobiletools.smsmessenger.adapters.MyRecyclerViewListAdapter<Conversation>(activity, recyclerView, ConversationDiffCallback(), itemClick, onRefresh),
